...
\begin{center}
	\includegraphics[width=14cm]{../NaT2/bilder/08_noise_blockdiag.png}
\end{center}
...
\begin{center}
	\includegraphics[height=1.8cm]{../NaT2/bilder/08_noise_baseband.png}
\end{center}
...
\begin{center}
	\includegraphics[height=2.5cm]{../NaT2/bilder/08_continuous_wave_communication.png}
\end{center}
