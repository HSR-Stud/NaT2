...
\subsection{Basisband \schaum{203-8.3}}
...
\subsection{Winkelmodulation \schaum{208-8.5}}
\begin{center}
...
\subsubsection{SNR bei PM \schaum{210-8.5.B}}
$$ \left(\dfrac{S}{N}\right)_0 =
\dfrac{k_p^2 A_c^2 S_x}{2 \eta B} = k_p^2 S_x \gamma $$

\subsubsection{SNR bei FM \schaum{210-8.5.C}}
$$ \left(\dfrac{S}{N}\right)_0 =
