...
\subsubsection{Matched Filter \schaum{229-9.4.A}} \label{09_matched_filter}
...
\subsubsection{Korrelator \schaum{230-9.4.B}} \label{09_korrelator}
...
\renewcommand{\arraystretch}{2}
	\begin{tabular}{ p{6cm} p{2.5cm} p{9cm} }
		...
		$P_e=Q\left(\sqrt{\dfrac{E_d}{2n}}\right)$
		& $E_d =$ Energie des Differenzsignals
		& \\
